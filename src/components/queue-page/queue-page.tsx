...
import stylesQueue from "./queue-page.module.css";
...
export const QueuePage: React.FC = () => {
  ...
  return (
    <SolutionLayout title="Очередь">
      <form className={stylesQueue.form}>
        <Input
          extraClass={stylesQueue.input}
          type="text"
          isLimitText={true}
          maxLength={4}
          value={`${inputValue}`}
        ...
        />
        <Button
          extraClass={stylesQueue.button_type_reset}
          text="Очистить"
      ...
      <div className={stylesQueue.list}>
